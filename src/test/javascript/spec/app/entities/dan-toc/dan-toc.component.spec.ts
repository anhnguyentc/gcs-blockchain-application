...
import { DanTocComponent } from 'app/entities/dan-toc/dan-toc.component';
import { DanTocService } from 'app/entities/dan-toc/dan-toc.service';
import { DanToc } from 'app/shared/model/dan-toc.model';

describe('Component Tests', () => {
  describe('DanToc Management Component', () => {
    let comp: DanTocComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DanTocComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.danTocs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
