...
import { BenhVienComponent } from 'app/entities/benh-vien/benh-vien.component';
...
describe('Component Tests', () => {
  describe('BenhVien Management Component', () => {
    let comp: BenhVienComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(BenhVienComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.benhViens[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
