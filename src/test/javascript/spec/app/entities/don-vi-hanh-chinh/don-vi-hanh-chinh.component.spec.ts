...
import { DonViHanhChinhComponent } from 'app/entities/don-vi-hanh-chinh/don-vi-hanh-chinh.component';
...
describe('Component Tests', () => {
  describe('DonViHanhChinh Management Component', () => {
    let comp: DonViHanhChinhComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DonViHanhChinhComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.donViHanhChinhs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
