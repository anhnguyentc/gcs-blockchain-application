...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, vn.vnpt.ehealt.blockchain.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, vn.vnpt.ehealt.blockchain.repository.UserRepository.USERS_BY_EMAIL_CACHE);
