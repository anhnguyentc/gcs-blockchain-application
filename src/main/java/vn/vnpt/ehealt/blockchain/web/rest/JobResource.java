...
import vn.vnpt.ehealt.blockchain.domain.Job;
import vn.vnpt.ehealt.blockchain.repository.JobRepository;
...
/**
 * REST controller for managing {@link vn.vnpt.ehealt.blockchain.domain.Job}.
 */
@RestController
@RequestMapping("/api")
